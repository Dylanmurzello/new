...
for subreddit in subreddits:
  try:
    ...
    com = "###[hot album mega]({}), {}".format(comment2, name2)
    time.sleep(10)
    submission.reply(com)
    print ("done")
  except Exception as err:
...
for subreddit in subreddits:
  try:
    ...
    com = "###[mega album]({}), {}".format(comment3, name3)
    time.sleep(10)
    submission.reply(com)
    print ("done")
  except Exception as err:
...
for subreddit in subreddits:
  try:
    ...
    com = "###[new pack]({}), {}".format(comment4, name4)
    time.sleep(10)
    submission.reply(com)
    print ("done")
  except Exception as err:
...
for subreddit in subreddits:
  try:
    ...
    com = "###[hot pack]({}), {}".format(comment5, name5)
    time.sleep(10)
    submission.reply(com)
    print ("done")
  except Exception as err:
...
for subreddit in subreddits:
  try:
    ...
    com = "###[meg@ hot pak]({}), {}".format(comment6, name6)
    time.sleep(10)
    submission.reply(com)
    print ("done")
  except Exception as err:
