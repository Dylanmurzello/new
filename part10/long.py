...
for subreddit in subreddits:
  try:
    ...
    com = "###[hot mega pack]({}), {}".format(comment2, name2)
    time.sleep(10)
    submission.reply(com)
    print ("done")
  except Exception as err:
...
for subreddit in subreddits:
  try:
    ...
    com = "###[mega hot pack]({}), {}".format(comment3, name3)
    time.sleep(10)
    submission.reply(com)
    print ("done")
  except Exception as err:
...
for subreddit in subreddits:
  try:
    ...
    com = "###[mega album pack]({}), {}".format(comment5, name5)
    time.sleep(10)
    submission.reply(com)
    print ("done")
  except Exception as err:
...
for subreddit in subreddits:
  try:
    ...
    com = "###[Album]({}), {}".format(comment6, name6)
    time.sleep(10)
    submission.reply(com)
    print ("done")
  except Exception as err:
...
for subreddit in subreddits:
  try:
    ...
    com = "###[new hot album]({}), {}".format(comment8, name8)
    time.sleep(10)
    submission.reply(com)
    print ("done")
  except Exception as err:
