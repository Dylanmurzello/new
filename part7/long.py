...
reddit = praw.Reddit(client_id="Dj0YK3JJexZIyA",
                     client_secret="cyw8ceSXeQpE2DczRqOuBKueXEpMFA",
...
for subreddit in subreddits:
  try:
    ...
    com = "###[new album]({}), {}".format(comment, name)
    time.sleep(10)
...
for subreddit in subreddits:
  try:
    ...
    com = "###[hotpack mega album]({}), {}".format(comment2, name2)
    time.sleep(10)
    submission.reply(com)
    print ("done")
  except Exception as err:
